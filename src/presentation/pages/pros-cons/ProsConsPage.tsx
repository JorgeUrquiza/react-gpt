...
export const ProsConsPage = () => {
    ...
    const handlePost = async (text: string) => {
      ...
      if ( !ok ) return; // Si no es ok, no hace nada


      setMessages((prev) => [...prev, { text: content, IsGpt: true }]); // Agrega el mensaje de GPT a la lista de mensajes
      ...
      <div className="chat-container" >
        <div className="chat-messages">
          <div className="grid grid-cols-12 gap-y-2">
            ...
            {/* Bienvenida */}
            <GptMessage text="Puedes escribir lo que quieras comparar" />
